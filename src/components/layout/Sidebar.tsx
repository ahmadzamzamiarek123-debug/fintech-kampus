...
const operatorNav: NavItem[] = [
  ...
  { label: 'Kelola Tagihan', href: '/operator/tagihan', icon: <DocumentIcon /> },
  { label: 'Pengeluaran', href: '/operator/pengeluaran', icon: <CurrencyIcon /> },
...
export function Sidebar({ isOpen, onClose }: SidebarProps) {
  ...
  const roleLabel = role === 'ADMIN' ? 'Administrator' : role === 'OPERATOR' ? 'Operator' : 'Mahasiswa'
